        ...
        <div>
            <div>
                <div>
                    ...
                    <div>
                        <img src={purchase} alt="" className='w-full h-[30rem]' />
                    </div>
                    <div className='flex gap-10 mt-5'>
                        <div className='w-[50%] ml-24'>
                            <p className='text-7xl font-bold font-serif'>
                                Purchase and Sale</p>
                            <p className='text-xl pt-4'>Use this e-greement to memorialize the terms of most any purchase and sale transaction. This e-greement will cover a wide variety of private party, retail and commercial transactions for new or used goods. Examples include: cars, bikes, jewelry, electronics, equipment, and household goods. Whether negotiating online or face-to-face, simply open the app, negotiate the terms most important to you both and, as quick as a handshake, you will have a clear and concise written contract describing how your transaction will be accomplished.</p>
                        </div>
                        <div className='w-[50%] mt-5 pl-10 text-center items-center justify-center'>
                            <img src={'https://e-gree.app/wp-content/themes/eGree/images/icon-purchase_and_sale.svg'} alt="" className='pl-64 h-40' />
                            ...
                            <header className='flex flex-col mt-5'>
                                <span>2066 purchase and sale</span>
                                <span>contracts have already signed</span>
                            </header>
                        </div>
                    </div>
